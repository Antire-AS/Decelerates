...
class Tender(Base):
    ...
    # Customer-facing portal — broker generates the token after running
    # the AI analysis. Customer opens /portal/tender/<token>, reviews,
    # approves or rejects. See migration p4q5r6s7t8u9 for the partial
    # unique index on customer_access_token.
