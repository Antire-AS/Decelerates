...
class Policy(Base):
    ...
    contact_person_id = Column(
        Integer, ForeignKey("contact_persons.id", ondelete="SET NULL"), nullable=True
    )
    ...
    status = Column(
        SAEnum(PolicyStatus, name="policy_status", create_type=False),
        nullable=False,
        default=PolicyStatus.active,
        index=True,
    )
    renewal_stage = Column(
        SAEnum(RenewalStage, name="renewal_stage", create_type=False),
        nullable=False,
        default=RenewalStage.not_started,
    )
    notes = Column(String, nullable=True)
...
class Activity(Base):
    ...
    claim_id = Column(
        Integer, ForeignKey("claims.id", ondelete="SET NULL"), nullable=True
    )
    firm_id = Column(
        Integer,
        ForeignKey("broker_firms.id", ondelete="RESTRICT"),
    ...
    activity_type = Column(
        SAEnum(ActivityType, name="activity_type", create_type=False), nullable=False
    )
