...
def _generate_reasoning(
    ...
    return (
        _llm_answer_raw(prompt)
        or f"{insurer_name} er anbefalt basert på appetittmatch og historisk tilslagsrate."
    )
    ...
    return [
        {
            ...
            "reasoning": _generate_reasoning(
                ins.name, score, company_name, product_types
            ),
    ...
    def recommend_insurers(
        ...
        return {
            "recommendations": _build_recommendations(
                scored[:top_n], win_rates, company_name, product_types
            ),
            "company": {"orgnr": orgnr, "navn": company_name},
        }
...
def recommend_insurers(
    ...
    return InsurerMatchingService(db).recommend_insurers(
        orgnr, firm_id, product_types, top_n
    )
