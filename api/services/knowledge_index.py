...
class KnowledgeIndexService:
    ...
    def index_video_transcripts(self) -> int:
    ...
    def index_all(self) -> dict:
        ...
        docs_chunks = index_insurance_documents(self.db)
        video_chunks = index_video_transcripts(self.db)
...
def clear_knowledge(db: Session) -> int:
    return KnowledgeIndexService(db).clear_knowledge()


def index_insurance_documents(db: Session) -> int:
    return KnowledgeIndexService(db).index_insurance_documents()


def index_video_transcripts(db: Session) -> int:
    return KnowledgeIndexService(db).index_video_transcripts()


def index_all(db: Session) -> dict:
    return KnowledgeIndexService(db).index_all()


def get_stats(db: Session) -> dict:
    return KnowledgeIndexService(db).get_stats()
