 ...
 *
 * Renders the AI comparison + broker recommendation, then offers
 * the customer a single-click Approve / Reject. Approval today just
 * records the decision; DocuSeal hand-off happens via the broker's
 * existing contract-send flow.
 */
