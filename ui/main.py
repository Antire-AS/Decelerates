...
from ui.views.kurs import render_kurs_tab
...
tab_search, tab_portfolio, tab_docs, tab_sla, tab_knowledge, tab_kurs = st.tabs(
    ["Selskapsøk", "Portefølje", "Dokumenter", "Avtaler", "Kunnskapsbase", "Kursvideoer"]
)
