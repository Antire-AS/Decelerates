    ...
    policies = [
        {
            ...
            "coverage_amount_nok": 5_000_000,
            "annual_premium_nok": 45_000,
...
def test_generate_certificate_pdf_multiple_policies():
    policies = [
        ...
        },
        {
            ...
            "insurer": "If",
            "policy_number": "P2",
            "coverage_amount_nok": 10_000_000,
        ...
        },
        {
            ...
            "insurer": "Tryg",
            "policy_number": "",
            "coverage_amount_nok": None,
            "annual_premium_nok": None,
            "renewal_date": "",
            "status": "active",
        },
    ]
    ...
    policies = [
        {
            ...
            "insurer": "X",
            "policy_number": "1",
            "coverage_amount_nok": 1000,
            "annual_premium_nok": 100,
            "renewal_date": "2027-01-01",
            "status": "active",
        },
        {"product_type": "B", "insurer": "Y", "status": "expired"},
        {
            ...
            "insurer": "Z",
            "policy_number": "3",
            "coverage_amount_nok": 3000,
            "annual_premium_nok": 300,
    ...
    policies = [
        {
            ...
            "insurer": "I",
            "policy_number": "N",
            "coverage_amount_nok": 500,
            "annual_premium_nok": 50,
            "renewal_date": "2027-01-01",
            "status": "active",
        },
    ]
    ...
    policies = [
        {
            ...
            "insurer": "B" * 50,
            "policy_number": "C" * 50,
            "coverage_amount_nok": 99_999_999,
            "annual_premium_nok": 88_888_888,
