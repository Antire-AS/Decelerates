...
class TestExecuteIrTool:
    def test_web_search_calls_ddg(self):
        ...
        with patch(
            "api.services.pdf_agents_v2._ddg_search_results",
            return_value=[
                {
                    "title": "DNB",
                    "url": "https://dnb.no/ar.pdf",
    ...
    def test_fetch_url_calls_fetch(self):
        ...
        with patch(
            "api.services.pdf_agents_v2._fetch_url_content",
            return_value={"text": "page content"},
        ):
...
class TestBuildIrSystemPrompt:
    def test_contains_company_info(self):
        ...
        prompt = _build_ir_system_prompt(
            "123456789", "DNB Bank ASA", "https://dnb.no", [2024, 2023]
        )
