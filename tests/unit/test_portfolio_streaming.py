...
@patch(
    "api.services.portfolio_streaming.fetch_enhetsregisteret",
    return_value=[{"organisasjonsnummer": "123", "navn": "Test"}],
)
@patch(
    "api.services.portfolio_streaming.fetch_org_profile",
    return_value={"org": {"orgnr": "123"}},
)
