...
def test_seed_pdf_sources_updates_url():
    seed = {
        "123456789": [
            {"year": 2023, "pdf_url": "https://example.com/new.pdf", "label": "New"}
        ]
    }
    existing = MagicMock()
    db = MagicMock()
...
def test_upsert_company_creates_new():
    ...
    org = {
        ...
        "land": "Norge",
        "naeringskode1": "64.11",
        "naeringskode1_beskrivelse": "Sentralbankvirksomhet",
    }
    regn = {
        "regnskapsår": 2023,
        "sum_driftsinntekter": 1_000_000,
        "sum_egenkapital": 200_000,
        "sum_eiendeler": 500_000,
    }
...
def test_upsert_company_updates_existing():
    ...
    org = {
        ...
        "land": "Norge",
        "naeringskode1": "46.90",
        "naeringskode1_beskrivelse": "Engroshandel",
    }
    regn = {
        "regnskapsår": 2024,
        "sum_driftsinntekter": 2_000_000,
        "sum_egenkapital": 400_000,
        "sum_eiendeler": 1_000_000,
    }
