...
class TestPdfGenerateServiceGenerateSla:
    def test_delegates_to_module_function(self):
        with patch(
            "api.services.pdf_generate._generate_sla_pdf", return_value=b"%PDF-sla"
        ) as mock_fn:
...
class TestPdfGenerateServiceGenerateRiskReport:
    def test_delegates_to_module_function(self):
        with patch(
            "api.services.pdf_generate.generate_risk_report_pdf",
            return_value=b"%PDF-risk",
        ) as mock_fn:
            from api.services.pdf_generate import PdfGenerateService
...
class TestPdfGenerateServiceGenerateForsikringstilbud:
    def test_delegates_to_module_function(self):
        with patch(
            "api.services.pdf_generate.generate_forsikringstilbud_pdf",
            return_value=b"%PDF-tilbud",
        ) as mock_fn:
            from api.services.pdf_generate import PdfGenerateService
...
class TestPdfGenerateServiceGeneratePortfolio:
    def test_delegates_to_module_function(self):
        with patch(
            "api.services.pdf_generate.generate_portfolio_pdf",
            return_value=b"%PDF-port",
        ) as mock_fn:
            from api.services.pdf_generate import PdfGenerateService
